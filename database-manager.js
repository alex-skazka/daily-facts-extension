class DatabaseManager {
  ...
  updateStats() {
    ...
    document.getElementById("visibleFacts").textContent = visible
    document.getElementById("hiddenFacts").textContent = hidden
...
// Initialize the database manager when DOM is loaded
